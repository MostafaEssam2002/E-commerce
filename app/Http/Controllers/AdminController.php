...
class AdminController extends Controller
{
    ...
    {
        [$currentMonth, $currentYear] = $this->getSelectedMonthAndYear();
        ...
        $previousMonthYear = $previousDate->year;
...
public function addusers(){
    ...
    public function settings()
    {
        ...
        return view('admin_panal.settings', compact('selectedMonth', 'selectedYear'));
    }
    ...
    public function updateSelectedMonth(Request $request)
    {
        ...
        $request->session()->put('selected_month', $request->selected_month);
        $request->session()->put('selected_year', now()->year);

        return redirect()->route('settings')->with('status', 'Selected month updated successfully.');
    }
