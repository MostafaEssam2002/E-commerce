                            ...
                            <ul>
                                ...
                                @guest
                                    ...
                                    @if (Route::has('register'))
                                        <li class="nav-item"><a href="{{ route('register') }}">{{ __('Register') }}</a>
                                        </li>
                                    @endif
                                @else
                                        ...
                                        <ul class="sub-menu">
                                            <li>
                                                <a href="#" onclick="changeLanguage('en')"
                                                    class="{{ session('locale') == 'en' ? 'active-lang' : '' }}">
                                                    English
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" onclick="changeLanguage('ar')"
                                                    class="{{ session('locale') == 'ar' ? 'active-lang' : '' }}">
                                                    عربي
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <li>
                                        <a class="user-avatar-link">
                                            <div class="user-avatar-container">
                                                <img src="{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : asset('assets/img/users/default-avatar.png') }}" alt="image {{ Auth::user()->name }}" class="user-avatar">
                                            </div>
                    ...
                    <div class="search-bar">
                        <div class="search-bar-tablecell">
                            ...
                            <form action="{{ route('search') }}" method="POST">
                                @csrf
                                <input type="text" placeholder="Keywords" name="catname">
