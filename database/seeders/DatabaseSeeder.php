...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ["id"=>1,"name"=>"admin","email"=>"admin@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>"$2y$12$49S7qGyno0i2sNyyoPSZ/ODzp4RkMSOshdKqzEq1VBBu4pnhZFqJe","remember_token"=>"9166ozUCyuCTQ6sxOEi6HofZO6jar1ge8bvUh7VRFNg2xM44Rkaoz8NABHOw","created_at"=>now()->format('Y-m-d H:i:s'),"updated_at"=>now()->format('Y-m-d H:i:s'),"role"=>"admin"],
            ["id"=>2,"name"=>"ahmed","email"=>"ahmed@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>'$2y$12$dxo26kbUX269QzMpwl4FBOdtx0Q.OKU96Q4kQ45t0.zR8.ysEuzf6',"remember_token"=>"hTUvV0twguWfZyJx4JwaxF8KrSQ2WTMPbZBVj76tGaE2tLvOfuvkSfnDS1bJ","created_at"=>now()->subMonths(8)->format('Y-m-d H:i:s'),"updated_at"=>now()->subMonths(8)->format('Y-m-d H:i:s'),"role"=>"user"],
            ["id"=>3,"name"=>"amr","email"=>"amr@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>'$2y$12$nY0MEAlPPF/g2a4L.5/ZkOjN6UtRntIPoSm7uk3GDQSi9uPciP6iS',"remember_token"=>null,"created_at"=>now()->subMonths(6)->format('Y-m-d H:i:s'),"updated_at"=>now()->subMonths(6)->format('Y-m-d H:i:s'),"role"=>"user"],
            ["id"=>7,"name"=>"mostafa essam","email"=>"mostafa@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>'$2y$12$l/eQwhbnR10J6k5o3LlJ.utaOz5DIBeUoLkzTD2Z9aTtCHQ7dRfRC',"remember_token"=>null,"created_at"=>now()->subMonths(5)->format('Y-m-d H:i:s'),"updated_at"=>now()->subMonths(5)->format('Y-m-d H:i:s'),"role"=>"user"],
            ["id"=>8,"name"=>"test","email"=>"test@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>'$2y$12$L.ppgd6N6WWoeLsbxLzBdeJhBoNgrUCNl/vGRhTtCcBdTuy0ky3bS',"remember_token"=>null,"created_at"=>now()->subMonths(4)->format('Y-m-d H:i:s'),"updated_at"=>now()->subMonths(4)->format('Y-m-d H:i:s'),"role"=>"user"],
            ["id"=>9,"name"=>"seller","email"=>"seller@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>'$2y$12$xeP1Qk11u2emiaibGMopo.Dbl7C0WXHdeNVA9ypdWilkA0PsXgdfS',"remember_token"=>null,"created_at"=>now()->subMonths(3)->format('Y-m-d H:i:s'),"updated_at"=>now()->subMonths(3)->format('Y-m-d H:i:s'),"role"=>"seller"],
            ["id"=>10,"name"=>"tester","email"=>"tester@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>'$2y$12$nv12rBqxKXY4qHZJXo4EwObZFOOyEfVO2onlrnXQvIcwuUyOBydka',"remember_token"=>null,"created_at"=>now()->subMonths(2)->format('Y-m-d H:i:s'),"updated_at"=>now()->subMonths(2)->format('Y-m-d H:i:s'),"role"=>"user"],
            ["id"=>11,"name"=>"mostafa essam","email"=>"mo@gmail.com","avatar"=>"assets/img/users/d7b7bc28-0734-4d2a-9e6a-f4ffbf8c06db.jpg","email_verified_at"=>null,"password"=>'$2y$12$i6tVt7aK959vOUDjoTC5z.0GoweuOHelEQ4YNdDd6aRXunDVfQJTC',"remember_token"=>null,"created_at"=>now()->subMonths(1)->format('Y-m-d H:i:s'),"updated_at"=>now()->subMonths(1)->format('Y-m-d H:i:s'),"role"=>"user"],
        ];
